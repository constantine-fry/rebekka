...
open class Session {
    ...
    open func download(_ path: String, progressHandler: @escaping ProgressHandler, completionHandler: @escaping FileURLResultCompletionHandler) {
        if path.isEmpty {
            print("Empty Path")
            return
        }
        ...
        self.list(directory) { (items, error) in
            if error == nil, let array = items {
                ...
                operation.progressBlock = { percent in
                    self.completionHandlerQueue.addOperation {
    ...
    open func upload(_ fileURL: URL, path: String, progressHandler: @escaping ProgressHandler, completionHandler: @escaping BooleanResultCompletionHandler) {
